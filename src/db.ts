...
export abstract class DB {
  ...
  public static register(source: DataSource): any
  public static register(sourceName: string, source: DataSource): any
  public static register(sourceOrName: DataSource | string, source?: DataSource): any {
  ...
  private static get activeSource(): DataSource {
    ...
    return this.sources.values().next().value as DataSource
  }
}
